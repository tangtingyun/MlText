...
import com.example.mltext.R
import com.yunlu.wms.lib_common.ocr.analyzer.TextAnalyzer
import com.example.mltext.ocr.util.ScopedExecutor
        ...
        overlay.apply {
            ...
            holder.addCallback(object : SurfaceHolder.Callback {
                ...
                override fun surfaceCreated(holder: SurfaceHolder) {
                    holder?.let {
                        drawOverlay(
                            it, DESIRED_HEIGHT_CROP_PERCENT, DESIRED_WIDTH_CROP_PERCENT
                        )
                    }
                }
            })
